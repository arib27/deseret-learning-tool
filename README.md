...
#### function 1
  The first part of the application will be a flashcard-based system, prompting memory and recognition, and for users to associate Deseret symbols with sounds instead of English writing conventions.
#### function 2
  The second part of the application will be a text-input system which prompts users to sound out text they see written in the Deseret and 'translate' it into Latin text.
#### function 3
  The third part of the application will also be a text-input system, this time prompting users to 'translate' from Latin text to Deseret text.
