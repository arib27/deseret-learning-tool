...
#### Card class
  This is the core of the application which stores information on flashcards. Data will be imported from a .json dictionary.
#### Scheduler function
  This function changes the interval of when each flashcard is shown to the user, creating spaced-repetition learning.
#### Review loop
